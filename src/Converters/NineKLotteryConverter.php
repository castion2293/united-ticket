 ...
 */
class NineKLotteryConverter extends Converter
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->gameTypes = array_keys(config('api_caller.nine_k_lottery.game_scopes'));
    }
    ...
    public function transform(array $rawTickets = [], string $userId = ''): array
    {
        ...
        foreach ($tickets as $ticket) {
            ...
            // TODO: 先讓測試先通過，以後再補MOCK
            if (app()->environment() !== 'testing') {
                $account = array_get($ticket, 'MemberAccount');
