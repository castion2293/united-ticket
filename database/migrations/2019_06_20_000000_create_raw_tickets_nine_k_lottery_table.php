...
class CreateRawTicketsNineKLotteryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::dropIfExists('raw_tickets_nine_k_lottery');

        Schema::create('raw_tickets_nine_k_lottery', function (Blueprint $table) {
            // [PK] 資料識別碼
            $table->uuid('uuid')
                ->comment('資料識別碼');
