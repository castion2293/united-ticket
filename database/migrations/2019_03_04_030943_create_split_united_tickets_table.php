...
class CreateSplitUnitedTicketsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('split_united_tickets', function (Blueprint $table) {
            // [PK] 資料識別碼
            $table->uuid('id')
                ->comment('資料識別碼');
    ...
    {
        Schema::dropIfExists('split_united_tickets');
    }
}
