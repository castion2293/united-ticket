...
use SuperPlatform\UnitedTicket\Fetchers\NineKLotteryFetcher;
use SuperPlatform\UnitedTicket\Models\NineKLotteryTicket;

class NineKLotteryFetcherTest extends BaseTestCase
{
    ...
    public function testRawTicketUuid()
    {
        ...
        //   Act
        // -----------
        $ticket = new NineKLotteryTicket($this->rawTicketData_1);
    ...
    public function testSuccessCapture()
    {
        ...
        //   Act
        // -----------
        $fetcher = new NineKLotteryFetcher([]);
    ...
    public function testFetchSameFirstTicket()
    {
        ...
        call_user_func([NineKLotteryTicket::class, 'replace'], $fetchTickets);
